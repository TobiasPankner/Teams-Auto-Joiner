...
- **leave_if_last:**
  If true, leaves the meeting if you are the last person in it. Default is true.

- **leave_threshold_number: (leave_if_last must be true in order for this to work)**
  The threshold number of people for leaving the meeting. If remaining participants is less than this threshold, will leave the meeting.
